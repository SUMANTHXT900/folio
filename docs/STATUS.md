...
| Frontend unit tests (`npm test`) | 134 passing (118 + 16 new page-assembly tests) |
| Production build (`npm run build`, PWA SW with WASM precache) | passing, zero testbench strings in bundle |
| Canonical E2E (`node e2e/studio.e2e.mjs`, no corpus) | 25/25 passing, 4 skipped (large-file sections need optional `test pdfs/merged.pdf`) |
